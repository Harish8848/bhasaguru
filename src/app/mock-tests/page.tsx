...
export default function MockTestsPage() {
  ...
  const filteredTests = tests.filter((test) => {
    ...
    if (
      selectedLevel &&
      selectedLevel !== "all" &&
      !test.title.toLowerCase().includes(selectedLevel.toLowerCase()) &&
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center space-y-6">
              <h1 className="text-4xl md:text-6xl font-bold leading-tight">
                <span className="text-primary">Mock Tests</span> for Language
                Proficiency
              </h1>
              <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
                Practice with our comprehensive mock tests designed for Japanese
                (JLPT), Korean (TOPIK), IELTS, and PTE examinations. Build
            ...
            {!loading && isEnrolled === false ? (
              <div className="text-center py-16">
                ...
                <p className="text-muted-foreground">
                  Unlock your learning and practice with mock tests.
                </p>
                <div className="mt-6">
                  <Button
